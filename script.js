...
window.onload = function() {
    ...
    document.getElementById('color1').addEventListener('click', function() {
        currentColor = [0.671, 0.729, 0.447, 1.0];  // Light Pink (RGB 231, 204, 204)
        drawScene();
    });

    // Change color to light blue
    document.getElementById('color2').addEventListener('click', function() {
        currentColor = [0.996, 0.863, 0.482, 1.0];  // Light Blue
        drawScene();
    });

    document.getElementById('color3').addEventListener('click', function() {
        currentColor = [0.722, 0.482, 0.361, 1.0];  // Reset to Light Pink (default)
        drawScene();
    });

    // Reset to the default light pink color
    document.getElementById('resetColor').addEventListener('click', function() {
        currentColor = [0.671, 0.729, 0.447, 1.0];  // Reset to Light Pink (default)
        drawScene();
    });
